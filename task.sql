# In the first case (ENGINE=InnoDB) Query_time is 0.001311 and Lock_time is 0.000004
# In the second case (ENGINE=MyISAM) Query_time is 0.000007 and Lock_time is 0.000000
# Analyzing the data, we can conclude that using the MyISAM engine gives a faster response when we are
